...
const getProductReview = async (payload , data , loading ) => {
  try{
    const response = await axios.get(`${Baseurl}api/v1/product/getProductReviews/64e0a884b99a904f12c37f54`)
    data(response.datareviews)
  }catch{}
}