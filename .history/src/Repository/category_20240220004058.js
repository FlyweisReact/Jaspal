...
export const cancel_order = async (id, payload, loading) => {
  loading(true);
  try {
    const response = await axios.put(
      `${Baseurl}api/v1/order/cancelReturnOrder/${id}`,
      payload,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("Token")}`,
...
export const get_wallet = async (setResponse) => {
  try {
    const response = await axios.get(`${Baseurl}api/v1/wallet/getwallet`, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("Token")}`,
      },
    });
...
export const add_money = async (payload) => {
  try {
    const response = await axios.post(
      `${Baseurl}api/v1/wallet/addWallet`,
      payload,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("Token")}`,
...
export const send_money = async (payload) => {
  try {
    const response = await axios.post(
      `${Baseurl}api/v1/wallet/sendMoney`,
      payload,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("Token")}`,
