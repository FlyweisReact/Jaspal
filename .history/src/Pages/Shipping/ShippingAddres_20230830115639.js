...
const ShippingAddres = () => {
  ...
  const payload = { email , firstName , lastName , phone , address , pincode , city , state , country }
                ...
                <form onSubmit={postHandler}>
                  ...
                  <div className="single-Input Double">
                    <div>
                      ...
                      <input type="text" name="pincode" onChange={(e) => setPincode(e.target.value)} required  />
                    </div>
                    <div>
                      <label>City*</label>
                  ...
                  <div className="single-Input Double">
                    <div>
                      <label>State*</label>
                      <input type="text" name='state' onChange={(e) => setState(e.target.value)} required  />
                    </div>
                    <div>
                      <label>Country*</label>
                      <input type="text"  name="country" onChange={(e) => setCountry(e.target.value)} required />
                    </div>
                  </div>
