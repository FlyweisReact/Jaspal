...
const SingleProduct = () => {
  ...
  useEffect(() => {
    indivisualProduct(setLoading, setProduct, id, setImage, setProductImages);
    getProductVarients(setVarients, id);
  }, [id]);
                    ...
                    {varients?.map((i, index) => (
                      <div
                        ...
                        onClick={() => {
                          ...
                          productImages.push(i.productImages);
                        }}
